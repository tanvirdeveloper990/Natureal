                ...
                <div class="card shadow-lg border-0 rounded-4">
                    ...
                    <div class="card-header bg-gradient-purple">
                        <div class="d-flex justify-content-between align-items-center text-white">
                            <h5 class="mb-0 fw-semibold">Add Customer Review</h5>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.customer-review.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="review_text" id="review_text" rows="4"
                                    ...
                                    placeholder="Write review...">{{ old('review_text') }}</textarea>
                                @error('review_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
